document.addEventListener("DOMContentLoaded", () => {
  ...
  window.addEventListener("scroll", () => {
    menuToggler.querySelector(".icon-hamburger").classList.remove("hidden");
    menuToggler.querySelector(".icon-x").classList.add("hidden");
  ...
  menuToggler.addEventListener("click", function () {
    this.querySelector(".icon-hamburger").classList.toggle("hidden");
    this.querySelector(".icon-x").classList.toggle("hidden");
    if (window.scrollY > 10) {
